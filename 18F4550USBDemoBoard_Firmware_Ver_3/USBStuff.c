...
void showByteOnLEDs(BYTE byteToShow) {
	if((byteToShow & 0b10000000) == 0b10000000) LED11 = 1;
	else LED11 = 0;
	
	if((byteToShow & 0b01000000) == 0b01000000) LED10 = 1;
	else LED10 = 0;
	
	if((byteToShow & 0b00100000) == 0b00100000) LED9  = 1;
	else LED9  = 0;
	
	if((byteToShow & 0b00010000) == 0b00010000) LED8  = 1;
	else LED8  = 0;
	
	if((byteToShow & 0b00001000) == 0b00001000) LED7  = 1;
	else LED7  = 0;
	
	if((byteToShow & 0b00000100) == 0b00000100) LED6  = 1;
	else LED6  = 0;
	
	if((byteToShow & 0b00000010) == 0b00000010) LED5  = 1;
	else LED5  = 0;
	
	if((byteToShow & 0b00000001) == 0b00000001) LED4  = 1;
	else LED4  = 0;
}
